...
/*
    number : 정수 및 실수 모두를 포함하는 타입
*/
var integer = 10;
var double = 10.0;

/* 
    - number 타입의 값들은 표기법만 다르고 값은 같을 수 있다.
*/
console.log(integer);
console.log(double);
...
/*
    - javascript의 문자열은 배열처럼 인덱스를 이용해서 접근 가능 (유사 배열)
*/
...
/*
    ...
    - 변수에 저장된 메모리 주소를 제저하는 용도
    - 함수의 반환값으로 유효한 갓이 없을때 반환
    - null 값을 typeof 연산자로 확인하면 object라는 타입이 반환됨(단순 자바스크립트 문재)
*/
obj = null;
